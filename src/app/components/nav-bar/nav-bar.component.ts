  ...
  template: `
    <nav class="fixed bottom-0 left-0 right-0 bg-zinc-950/70 backdrop-blur-2xl border-t border-white/10 pb-safe pt-2 px-2 z-50">
      <div class="flex justify-between items-center max-w-md mx-auto">
        ...
        <a routerLink="/table" routerLinkActive="text-blue-400" class="flex flex-col items-center text-zinc-500 hover:text-blue-300 transition-colors p-2 flex-1">
          <mat-icon class="mb-1">table_chart</mat-icon>
          <span class="text-[10px] font-medium tracking-wide">Tabela</span>
        </a>
